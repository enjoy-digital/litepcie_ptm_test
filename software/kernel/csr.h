...
#define CSR_TIME_CONTROLLER_TIME_ADDR (CSR_BASE + 0x5004L)
#define CSR_TIME_CONTROLLER_TIME_SIZE 2
#define CSR_TIME_CONTROLLER_OVERRIDE_TIME_ADDR (CSR_BASE + 0x500cL)
#define CSR_TIME_CONTROLLER_OVERRIDE_TIME_SIZE 2
