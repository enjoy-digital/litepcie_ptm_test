//--------------------------------------------------------------------------------
// Auto-generated by LiteX (94a0a5b0) on 2023-06-19 16:35:28
//--------------------------------------------------------------------------------
...
/* adc_analyzer */
#define CSR_ADC_ANALYZER_BASE (CSR_BASE + 0x0L)
#define CSR_ADC_ANALYZER_MUX_VALUE_ADDR (CSR_BASE + 0x0L)
#define CSR_ADC_ANALYZER_MUX_VALUE_SIZE 1
#define CSR_ADC_ANALYZER_TRIGGER_ENABLE_ADDR (CSR_BASE + 0x4L)
#define CSR_ADC_ANALYZER_TRIGGER_ENABLE_SIZE 1
#define CSR_ADC_ANALYZER_TRIGGER_DONE_ADDR (CSR_BASE + 0x8L)
#define CSR_ADC_ANALYZER_TRIGGER_DONE_SIZE 1
#define CSR_ADC_ANALYZER_TRIGGER_MEM_WRITE_ADDR (CSR_BASE + 0xcL)
#define CSR_ADC_ANALYZER_TRIGGER_MEM_WRITE_SIZE 1
#define CSR_ADC_ANALYZER_TRIGGER_MEM_MASK_ADDR (CSR_BASE + 0x10L)
#define CSR_ADC_ANALYZER_TRIGGER_MEM_MASK_SIZE 9
#define CSR_ADC_ANALYZER_TRIGGER_MEM_VALUE_ADDR (CSR_BASE + 0x34L)
#define CSR_ADC_ANALYZER_TRIGGER_MEM_VALUE_SIZE 9
#define CSR_ADC_ANALYZER_TRIGGER_MEM_FULL_ADDR (CSR_BASE + 0x58L)
#define CSR_ADC_ANALYZER_TRIGGER_MEM_FULL_SIZE 1
#define CSR_ADC_ANALYZER_SUBSAMPLER_VALUE_ADDR (CSR_BASE + 0x5cL)
#define CSR_ADC_ANALYZER_SUBSAMPLER_VALUE_SIZE 1
#define CSR_ADC_ANALYZER_STORAGE_ENABLE_ADDR (CSR_BASE + 0x60L)
#define CSR_ADC_ANALYZER_STORAGE_ENABLE_SIZE 1
#define CSR_ADC_ANALYZER_STORAGE_DONE_ADDR (CSR_BASE + 0x64L)
#define CSR_ADC_ANALYZER_STORAGE_DONE_SIZE 1
#define CSR_ADC_ANALYZER_STORAGE_LENGTH_ADDR (CSR_BASE + 0x68L)
#define CSR_ADC_ANALYZER_STORAGE_LENGTH_SIZE 1
#define CSR_ADC_ANALYZER_STORAGE_OFFSET_ADDR (CSR_BASE + 0x6cL)
#define CSR_ADC_ANALYZER_STORAGE_OFFSET_SIZE 1
#define CSR_ADC_ANALYZER_STORAGE_MEM_LEVEL_ADDR (CSR_BASE + 0x70L)
#define CSR_ADC_ANALYZER_STORAGE_MEM_LEVEL_SIZE 1
#define CSR_ADC_ANALYZER_STORAGE_MEM_DATA_ADDR (CSR_BASE + 0x74L)
#define CSR_ADC_ANALYZER_STORAGE_MEM_DATA_SIZE 1
