...
/* time_generator */
#define CSR_TIME_GENERATOR_BASE (CSR_BASE + 0x5000L)
#define CSR_TIME_GENERATOR_CONTROL_ADDR (CSR_BASE + 0x5000L)
...
#define CSR_TIME_GENERATOR_READ_TIME_ADDR (CSR_BASE + 0x5004L)
#define CSR_TIME_GENERATOR_READ_TIME_SIZE 2
#define CSR_TIME_GENERATOR_WRITE_TIME_ADDR (CSR_BASE + 0x500cL)
